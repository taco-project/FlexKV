...
from flexkv.common.config import ModelConfig, CacheConfig, MooncakeTransferEngineConfig
    ...
    def __init__(self,
        ...
        if self.server_client_mode:
            ...
            if dp_client_id == 0:
                ...
                self.server_handle = KVServer.create_server(model_config=self.model_config,
            ...
            self.server_handle = None
            self.kv_task_engine = KVTaskEngine(self.model_config, self.cache_config, gpu_register_port, redis_meta=self.redis_meta_client)
