...
class TensorSharedHandle:
    ...
    def __init__(
        ...
        *,
        ...
        If data is a tensor that is allocated by cudamalloc, we will use the cudaIpcGetMemHandle
            method to export the TensorSharedHandle.
        If data is bytes-like, it means the memory has already been shared by CUDA IPC,
    ...
    def _init_from_tensor(
        ...
        try:
            ...
            raise RuntimeError(f"Both PyTorch and direct CUDA IPC export failed: {e}") from e
