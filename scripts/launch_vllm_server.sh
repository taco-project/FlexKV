...
Options:
  -p, --port PORT                           Server port (default: 30001)
  -m, --model MODEL_PATH                    Model path (default: Qwen3/Qwen3-8B)
  -t, --tensor-parallel-size SIZE           Tensor parallel size (default: 1)
  -s, --max-num-seqs NUM                    Maximum number of sequences (default: 128)
  -l, --max-model-len LEN                   Maximum model length (default: 4096)
  -g, --gpu-memory-utilization RATIO        GPU memory utilization (default: 0.9)
  --enable-flexkv [0|1]                     Enable FlexKV: 0=disabled, 1=enabled (default: 1)
