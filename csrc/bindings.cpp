...
PYBIND11_MODULE(c_ext, m) {
  ...
  py::class_<flexkv::TPTransferThreadGroup>(m, "TPTransferThreadGroup")
      .def(py::init<int, const std::vector<int64_t> &, int, int64_t, int, int,
           ...
           py::arg("num_gpus"), py::arg("gpu_block_ptrs_flat"), py::arg("num_tensors_per_gpu"),
           py::arg("cpu_blocks_ptr"), py::arg("dp_group_id"), py::arg("num_layers"),
...
#endif
#ifdef FLEXKV_ENABLE_GDS && FLEXKV_ENABLE_P2P
...
#endif
#ifdef FLEXKV_ENABLE_P2P
  // Distributed KV cache (P2P/Redis): BlockMeta, RedisMetaChannel, LocalRadixTree, DistributedRadixTree, RefRadixTree
