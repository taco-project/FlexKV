 ...
 *
 * Vendor-scoped GPU tensor handler. Moved here from csrc/gtensor_handler.cuh
 * during the GPU backend abstraction refactor (P3).
 */
#pragma once
#include <cstdint>
#include "../gpu_types.h"
...
// Backend type enumeration (LLM framework backend; *not* GPU vendor).
