...
def test_roundtrip(cpu_layout_name, dtype, tp_size, is_mla, chunk_size_per_device,
    ...
    print(f"\n{'='*60}")
    cache_kind = "MLA" if is_mla else "MHA"
    print(f"    {cache_kind} roundtrip test: layout={cpu_layout_name},chunk_size_per_device={case['chunk_bytes']}, layers={num_layers}, blocks={num_blocks}, kv_dim={kv_dim}, "
...
def test_roundtrip_tp(cpu_layout_name, dtype, tp_size, is_mla, chunk_size_per_device,
    ...
    print(f"\n{'='*60}")
    cache_kind = "MLA" if is_mla else "MHA"
    print(f"    {cache_kind} TP roundtrip: layout={cpu_layout_name}, chunk_size_per_device={chunk_size_per_device}, "
